...
public abstract class EntityLivingBase extends Entity {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (!potioneffect.onUpdate(this)) {
                    if (!this.WORLD.isRemote && !MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.living.PotionEvent.PotionExpiryEvent(this, potioneffect))) {
                        iterator.remove();
    ...
    public void clearActivePotions() {
        if (!this.WORLD.isRemote) {
            ...
            while (iterator.hasNext()) {
                ...
                if (MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.living.PotionEvent.PotionRemoveEvent(this, effect)))
                    continue;
    ...
    public void addPotionEffect(PotionEffect potioneffectIn) {
        if (this.isPotionApplicable(potioneffectIn)) {
            ...
            MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.living.PotionEvent.PotionAddedEvent(this, potioneffect, potioneffectIn));
            if (potioneffect == null) {
    ...
    public void removePotionEffect(Potion potionIn) {
        if (MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.living.PotionEvent.PotionRemoveEvent(this, potionIn)))
            return;
        ...
        if (!this.WORLD.isRemote) {
            ...
            for (EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values()) {
                ...
                if (!ItemStack.areItemStacksEqual(itemstack1, itemstack)) {
                    ...
                    MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.living.LivingEquipmentChangeEvent(this, entityequipmentslot, itemstack, itemstack1));
    ...
    public void curePotionEffects(ItemStack curativeItem) {
        ...
        while (iterator.hasNext()) {
            ...
            if (effect.isCurativeItem(curativeItem) && !MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.living.PotionEvent.PotionRemoveEvent(this, effect))) {
