...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener {
    ...
    public static ResourceLocation SUN_TEXTURES = new ResourceLocation("textures/environment/sun.png");
    public static ResourceLocation CLOUDS_TEXTURES = new ResourceLocation("textures/environment/clouds.png");
    ...
    public void renderSky(float partialTicks, int pass) {
        ...
        if (this.mc.WORLD.provider.getDimensionType().getId() == 1) {
            ...
            GlStateManager.color(0, 0, 0, f16);
