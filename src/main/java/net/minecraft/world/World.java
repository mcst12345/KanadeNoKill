...
public abstract class World implements IBlockAccess, net.minecraftforge.common.capabilities.ICapabilityProvider {
    ...
    public boolean addWeatherEffect(Entity entityIn) {
        if (MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.EntityJoinWorldEvent(entityIn, this)))
            return false;
    ...
    public boolean spawnEntity(Entity entityIn) {
        ...
        if (!flag && !this.isChunkLoaded(i, j, false)) {
            ...
            if (MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.EntityJoinWorldEvent(entityIn, this)) && !flag)
                return false;
    ...
    public List<AxisAlignedBB> getCollisionBoxes(@Nullable Entity entityIn, AxisAlignedBB aabb) {
        ...
        MinecraftForge.Event_bus.post(new net.minecraftforge.event.world.GetCollisionBoxesEvent(this, entityIn, aabb, list));
        return list;
    }
    ...
    public void loadEntities(Collection<Entity> entityCollection) {
        for (Entity entity4 : entityCollection) {
            if (!MinecraftForge.Event_bus.post(new net.minecraftforge.event.entity.EntityJoinWorldEvent(entity4, this))) {
