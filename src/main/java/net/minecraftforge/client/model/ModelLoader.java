...
public final class ModelLoader extends ModelBakery {
    ...
    public static Map<IRegistryDelegate<Item>, ItemMeshDefinition> customMeshDefinitions = Maps.newHashMap();
    public static Map<Pair<IRegistryDelegate<Item>, Integer>, ModelResourceLocation> customModels = Maps.newHashMap();
    ...
    public void onPostBakeEvent(IRegistry<ModelResourceLocation, IBakedModel> modelRegistry) {
        ...
        if (enableVerboseMissingInfo) {
            ...
            for (Entry<IBlockState, ModelResourceLocation> entry : blockModelShapes.getBlockStateMapper().putAllStateModelLocations().entrySet()) {
