...
public class CoreModManager {
    ...
    static {
        kanade.kill.Launch.LOGGER.info("Successfully fucked CoreModManager.");
    }
    ...
    private static FMLPluginWrapper loadCoreMod(LaunchClassLoader classLoader, String coreModClass, File location) {
        ...
        try {
            ...
            try {
                plugin = (IFMLLoadingPlugin) coreModClazz.newInstance();
            } catch (Throwable t) {
                FMLLog.log.error("Failed to construct coremod:", t);
                return null;
            }
            ...
            FMLLog.log.error("Unknown error:", coreModName, coreModClass, t);
        }
        return null;
    }
