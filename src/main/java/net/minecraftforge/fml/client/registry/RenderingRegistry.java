...
public class RenderingRegistry {
    public static final RenderingRegistry INSTANCE = new RenderingRegistry();

    public Map<Class<? extends Entity>, IRenderFactory<? extends Entity>> entityRenderers = Maps.newHashMap();
    public Map<Class<? extends Entity>, Render<? extends Entity>> entityRenderersOld = Maps.newHashMap();
