...
public class ListenerList {
    public static ImmutableList<ListenerList> allLists = ImmutableList.of();
    public static int maxSize = 0;

    @Nullable
    public ListenerList parent;
    public ListenerListInst[] lists = new ListenerListInst[0];
    ...
    public synchronized static void extendMasterList(ListenerList inst) {
    ...
    public ListenerListInst getInstance(int id) {
        return lists[id];
    }
