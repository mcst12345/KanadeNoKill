...
public class Loader {
     ...
     */
    public ListMultimap<String, String> reverseDependencies;
    /**
     * The canonical configuration directory
     */
    public File canonicalConfigDir;
    public File canonicalModsDir;
    public LoadController modController;
    public MinecraftDummyContainer minecraft;
    public MCPDummyContainer mcp;

    public static File minecraftDir;
    public static List<String> injectedContainers;
    public ImmutableMap<String, String> fmlBrandingProperties;
    public File forcedModFile;
     ...
     */
    public ModDiscoverer identifyMods(List<String> additionalContainers) {
    ...
    public void identifyDuplicates(List<ModContainer> mods) {
    ...
    public void disableRequestedMods() {
    ...
    public ListMultimap<String, ArtifactVersion> injectedBefore = ArrayListMultimap.create();
    public ListMultimap<String, ArtifactVersion> injectedAfter = ArrayListMultimap.create();

    public void readInjectedDependencies() {
