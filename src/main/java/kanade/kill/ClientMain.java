...
public class ClientMain {
    ...
    public static void main(String[] p_main_0_) {
        ...
        ArgumentAcceptingOptionSpec<Integer> argumentacceptingoptionspec6 = optionparser.accepts("proxyPort").withRequiredArg().defaultsTo("8080", new String[0]).ofType(Integer.class);
        ...
        if (s != null) {
            try {
                proxy = new Proxy(Type.SOCKS, new InetSocketAddress(s, optionset.valueOf(argumentacceptingoptionspec6)));
        ...
        for (Object o : ((Map) (new Gson()).fromJson(optionset.valueOf(argumentacceptingoptionspec15), field_152370_a)).entrySet()) {
            Entry entry = (Entry) o;
