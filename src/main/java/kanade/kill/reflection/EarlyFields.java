...
public class EarlyFields {
    ...
    public static final Object LaunchClassLoader_base;
    ...
    static {
        try {
            ...
            LaunchClassLoader_base = Unsafe.instance.staticFieldBase(field);
            LaunchClassLoader_offset = Unsafe.instance.staticFieldOffset(field);
