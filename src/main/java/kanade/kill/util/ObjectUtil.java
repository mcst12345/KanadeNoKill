...
public class ObjectUtil {
    ...
    public static Object generateObject(String cls) {
        try {
            return generateObject(Class.forName(cls));
        } catch (ClassNotFoundException e) {
            Launch.LOGGER.warn("The fuck ? Class not happen? This shouldn't happen!");
            return null;
        }
    }
