...
public class WorldServer implements Opcodes {
    public static void OverwriteLoadEntities(MethodNode mn) {
        ...
        list.add(new InvokeDynamicInsnNode("test", "()Ljava/util/function/Predicate;", new Handle(H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;"), Type.getType("(Ljava/lang/Object;)Z"), new Handle(H_INVOKESTATIC, "kanade/kill/util/EntityUtil", "isDead", "(Lnet/minecraft/entity/Entity;)Z"), Type.getType("(Lnet/minecraft/entity/Entity;)Z")));
