...
public class URLClassLoader extends SecureClassLoader implements Closeable {
    ...
    public WeakHashMap<Closeable, Void>
     ...
     * source and manifest.
     */
    public Package getAndVerifyPackage(String pkgname,
    ...
    // archive
    public void definePackageInternal(String pkgname, Manifest man, URL url) {
     ...
     */
    public boolean isSealed(String name, Manifest man) {
        Attributes attr = SharedSecrets.javaUtilJarAccess()
                .getTrustedAttributes(man, name.replace('.', '/').concat("/"));
        String sealed = null;
        if (attr != null) {
