...
public class ThreadPoolImpl implements ThreadPool {
    ...
    public static final ORBUtilSystemException wrapper =
    ...
    public int availableWorkerThreads = 0;
    ...
    public MonitoredObject threadpoolMonitoredObject;

    // ThreadGroup in which threads should be created
    public ThreadGroup threadGroup;

    public Object workersLock = new Object();
    public List<WorkerThread> workers = new ArrayList<>();
    ...
    // Package public method to get the monitored object for this
    // class
    ...
    public Thread createWorkerThreadHelper(String name) {
    ...
    public class WorkerThread extends Thread implements Closeable {
        ...
        public int threadId = 0; // unique id for the thread
        public volatile boolean closeCalled = false;
        public String threadPoolName;
        // name seen by Thread.getName()
        public StringBuffer workerThreadName = new StringBuffer();
        ...
        public String composeWorkerThreadName(String poolName, String workerName) {
